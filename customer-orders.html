                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                          ...
                          <ul class="list-unstyled mb-3">
                            ...
                            <li class="nav-item"><a class="nav-link-sub py-2 text-uppercase active" href="customer-orders.html">Orders history</a></li>
            ...
            <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">My orders</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">My orders      </li>
                    </ol>
                  </div>
                </div>
              </div>
        ...
        <div class="container py-4">
          <div class="row gy-5">
            ...
            <div class="col-lg-3">
              ...
              <nav class="nav flex-column nav-pills"><a class="nav-link text-sm active" href="customer-orders.html"> <i class="me-2 fas fa-list"></i><span>My orders</span></a><a class="nav-link text-sm" href="customer-wishlist.html"> <i class="me-2 fas fa-heart"></i><span>My wishlist</span></a><a class="nav-link text-sm" href="customer-account.html"> <i class="me-2 fas fa-user"></i><span>My account</span></a><a class="nav-link text-sm" href="index.html"> <i class="me-2 fas fa-door-open"></i><span>Logout</span></a>
              </nav>
            </div>
          </div>
        </div>
